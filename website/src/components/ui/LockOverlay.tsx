...
export function LockOverlay({ isLocked = true, message }: LockOverlayProps) {
  ...
  return (
    <div className="absolute inset-0 z-10 flex flex-col items-center justify-center rounded-xl bg-[#eaf1ff]/70 backdrop-blur-sm">
      ...
      <p className="mt-3 text-sm font-medium text-[#0e2a4d] px-4 text-center">
        {message || "Unlock to view full content"}
      </p>
      <Link
        to="/profile"
