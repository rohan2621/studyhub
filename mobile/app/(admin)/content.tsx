...
function SchoolPicker({ schools, selectedId, selectedName, onSelect, colors }: any) {
  if (selectedId) {
    return (
      <View style={{ backgroundColor: colors.success + "18", borderRadius: 0, padding: 14, flexDirection: "row", alignItems: "center", justifyContent: "space-between", borderWidth: 1, borderColor: colors.success + "40", marginBottom: 16 }}>
  ...
  return (
    <View style={{ backgroundColor: colors.inputBg, borderRadius: 0, overflow: "hidden", borderWidth: 1, borderColor: colors.border, marginBottom: 16 }}>
      {schools.length === 0 ? (
  ...
  const renderContent = () => {
    ...
    if (activeTab === "Notes") {
      ...
      return list.length === 0
        ...
        : list.map((n: any) => (
          <View key={n.id} style={{ backgroundColor: colors.card, borderRadius: 0, padding: 16, borderWidth: 1, borderColor: colors.border, marginBottom: 10 }}>
            <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "flex-start" }}>
              ...
              <View style={{ flexDirection: "row", gap: 8 }}>
                <TouchableOpacity onPress={() => handleEditNote(n)} style={{ backgroundColor: colors.primary + "18", borderRadius: 0, padding: 8 }}>
                  <Edit2 size={14} color={colors.primary} />
                </TouchableOpacity>
                <TouchableOpacity onPress={() => deleteNoteMutation.mutate(n.id)} style={{ backgroundColor: colors.danger + "18", borderRadius: 0, padding: 8 }}>
    ...
    if (activeTab === "Homework") {
      ...
      return list.length === 0
        ...
        : list.map((h: any) => (
          <View key={h.id} style={{ backgroundColor: colors.card, borderRadius: 0, padding: 16, borderWidth: 1, borderColor: colors.border, marginBottom: 10 }}>
            <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "flex-start" }}>
              <View style={{ flex: 1, marginRight: 10 }}>
              ...
              <View style={{ flexDirection: "row", gap: 8 }}>
                <TouchableOpacity onPress={() => handleEditHw(h)} style={{ backgroundColor: colors.primary + "18", borderRadius: 0, padding: 8 }}>
                  <Edit2 size={14} color={colors.primary} />
                </TouchableOpacity>
                <TouchableOpacity onPress={() => deleteHwMutation.mutate(h.id)} style={{ backgroundColor: colors.danger + "18", borderRadius: 0, padding: 8 }}>
                  <Trash2 size={14} color={colors.danger} />
                </TouchableOpacity>
              </View>
            </View>
    ...
    if (activeTab === "Papers") {
      ...
      return list.length === 0
        ...
        : list.map((p: any) => (
          <View key={p.id} style={{ backgroundColor: colors.card, borderRadius: 0, padding: 16, borderWidth: 1, borderColor: colors.border, marginBottom: 10 }}>
            <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "flex-start" }}>
              <View style={{ flex: 1, marginRight: 10 }}>
              ...
              <View style={{ flexDirection: "row", gap: 8 }}>
                <TouchableOpacity onPress={() => handleEditPaper(p)} style={{ backgroundColor: colors.primary + "18", borderRadius: 0, padding: 8 }}>
                  <Edit2 size={14} color={colors.primary} />
                </TouchableOpacity>
                <TouchableOpacity onPress={() => deletePaperMutation.mutate(p.id)} style={{ backgroundColor: colors.danger + "18", borderRadius: 0, padding: 8 }}>
                  <Trash2 size={14} color={colors.danger} />
                </TouchableOpacity>
              </View>
            </View>
    ...
    return list.length === 0
      ...
      : list.map((s: any) => (
        <View key={s.id} style={{ backgroundColor: colors.card, borderRadius: 0, padding: 16, borderWidth: 1, borderColor: colors.border, marginBottom: 10 }}>
          <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "flex-start" }}>
            <View style={{ flex: 1, marginRight: 10 }}>
            ...
            <View style={{ flexDirection: "row", gap: 8 }}>
              <TouchableOpacity onPress={() => handleEditSlot(s)} style={{ backgroundColor: colors.primary + "18", borderRadius: 0, padding: 8 }}>
                <Edit2 size={14} color={colors.primary} />
              </TouchableOpacity>
              <TouchableOpacity onPress={() => deleteSlotMutation.mutate(s.id)} style={{ backgroundColor: colors.danger + "18", borderRadius: 0, padding: 8 }}>
                <Trash2 size={14} color={colors.danger} />
              </TouchableOpacity>
            </View>
          </View>
      ...
      <View style={{ paddingTop: 60, paddingHorizontal: 20, paddingBottom: 20 }}>
        ...
        <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
          ...
          <TouchableOpacity
            ...
            style={{ backgroundColor: TAB_COLORS[activeTab], borderRadius: 0, paddingHorizontal: 16, paddingVertical: 10, flexDirection: "row", alignItems: "center", gap: 6 }}
          >
            ...
            {TABS.map((tab) => {
              ...
              return (
                <TouchableOpacity key={tab} onPress={() => setActiveTab(tab)}
                  style={{ flexDirection: "row", alignItems: "center", gap: 6, paddingHorizontal: 14, paddingVertical: 9, borderRadius: 0, backgroundColor: active ? TAB_COLORS[tab] : colors.card, borderWidth: 1, borderColor: active ? TAB_COLORS[tab] : colors.border }}>
      ...
      <ScrollView horizontal showsHorizontalScrollIndicator={false} style={{ paddingHorizontal: 20, paddingVertical: 12 }}>
        <View style={{ flexDirection: "row", gap: 8 }}>
          <TouchableOpacity
            ...
            style={{ paddingHorizontal: 14, paddingVertical: 7, borderRadius: 0, backgroundColor: !viewSchoolId ? TAB_COLORS[activeTab] : colors.card, borderWidth: 1, borderColor: !viewSchoolId ? TAB_COLORS[activeTab] : colors.border }}
          >
          ...
          {(schools ?? []).map((s: any) => (
            <TouchableOpacity
              ...
              style={{ paddingHorizontal: 14, paddingVertical: 7, borderRadius: 0, backgroundColor: viewSchoolId === s.id ? TAB_COLORS[activeTab] : colors.card, borderWidth: 1, borderColor: viewSchoolId === s.id ? TAB_COLORS[activeTab] : colors.border }}
            >
          ...
          <View style={{ flex: 1, backgroundColor: "#000000cc", justifyContent: "flex-end" }}>
            <View style={{ backgroundColor: colors.surface, borderTopLeftRadius: 0, borderTopRightRadius: 0, maxHeight: "94%" }}>
              ...
              <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center", padding: 24, paddingBottom: 16, borderBottomWidth: 1, borderBottomColor: colors.border }}>
                ...
                <TouchableOpacity onPress={resetModal} style={{ width: 36, height: 36, borderRadius: 0, backgroundColor: colors.inputBg, justifyContent: "center", alignItems: "center" }}>
              ...
              <ScrollView contentContainerStyle={{ padding: 24 }} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
                    ...
                    <View style={{ flexDirection: "row", gap: 8, marginBottom: 16 }}>
                      {NOTE_TYPES.map((t) => (
                        <TouchableOpacity key={t} onPress={() => setNoteType(t)}
                          style={{ flex: 1, paddingVertical: 10, borderRadius: 0, alignItems: "center", backgroundColor: noteType === t ? TAB_COLORS.Notes : colors.inputBg, borderWidth: 1, borderColor: noteType === t ? TAB_COLORS.Notes : colors.border }}>
                    ...
                    <View style={{ flexDirection: "row", gap: 6, marginBottom: 16 }}>
                      {GRADES_OPTIONS.map((g) => (
                        <TouchableOpacity key={g} onPress={() => setNoteGrade(g)}
                          style={{ flex: 1, paddingVertical: 10, borderRadius: 0, alignItems: "center", backgroundColor: noteGrade === g ? TAB_COLORS.Notes : colors.inputBg, borderWidth: 1, borderColor: noteGrade === g ? TAB_COLORS.Notes : colors.border }}>
                      ...
                      {["All", ...SECTIONS_OPTIONS].map((s) => {
                        ...
                        return (
                          <TouchableOpacity key={s} onPress={() => setNoteSection(isAll ? "" : s)}
                            style={{ flex: 1, paddingVertical: 10, borderRadius: 0, alignItems: "center", backgroundColor: active ? TAB_COLORS.Notes : colors.inputBg, borderWidth: 1, borderColor: active ? TAB_COLORS.Notes : colors.border }}>
                    ...
                    {[["Title", noteTitle, setNoteTitle, "Note title"], ["Subject", noteSubject, setNoteSubject, "e.g. Mathematics"], ["Chapter", noteChapter, setNoteChapter, "e.g. Algebra"], ["File URL", noteFileUrl, setNoteFileUrl, "https://drive.google.com/..."]].map(([label, val, setter, ph]: any) => (
                      <View key={label}>
                        ...
                        <TextInput value={val} onChangeText={setter} placeholder={ph} placeholderTextColor={colors.muted}
                          style={{ backgroundColor: colors.inputBg, borderRadius: 0, padding: 14, color: colors.text, borderWidth: 1, borderColor: val ? TAB_COLORS.Notes : colors.border, marginBottom: 16, fontSize: 14 }} />
                      </View>
                    ))}
                  </>
                )}
                ...
                {activeTab === "Homework" && (
                  <>
                    ...
                    <View style={{ flexDirection: "row", gap: 6, marginBottom: 16 }}>
                      {GRADES_OPTIONS.map((g) => (
                        <TouchableOpacity key={g} onPress={() => setHwGrade(g)}
                          style={{ flex: 1, paddingVertical: 10, borderRadius: 0, alignItems: "center", backgroundColor: hwGrade === g ? TAB_COLORS.Homework : colors.inputBg, borderWidth: 1, borderColor: hwGrade === g ? TAB_COLORS.Homework : colors.border }}>
                    ...
                    <View style={{ flexDirection: "row", gap: 6, marginBottom: 16 }}>
                      {SECTIONS_OPTIONS.map((s) => (
                        <TouchableOpacity key={s} onPress={() => setHwSection(s)}
                          style={{ flex: 1, paddingVertical: 10, borderRadius: 0, alignItems: "center", backgroundColor: hwSection === s ? TAB_COLORS.Homework : colors.inputBg, borderWidth: 1, borderColor: hwSection === s ? TAB_COLORS.Homework : colors.border }}>
                    ...
                    {[["Title", hwTitle, setHwTitle, "e.g. Chapter 5 exercises"], ["Subject", hwSubject, setHwSubject, "e.g. Mathematics"], ["Description", hwDesc, setHwDesc, "Describe the homework..."]].map(([label, val, setter, ph]: any) => (
                      <View key={label}>
                        ...
                        <TextInput value={val} onChangeText={setter} placeholder={ph} placeholderTextColor={colors.muted}
                          ...
                          style={{ backgroundColor: colors.inputBg, borderRadius: 0, padding: 14, color: colors.text, borderWidth: 1, borderColor: val ? TAB_COLORS.Homework : colors.border, marginBottom: 16, height: label === "Description" ? 80 : undefined, textAlignVertical: label === "Description" ? "top" : "auto", fontSize: 14 }} />
                      </View>
                    ))}
                    ...
                    <TextInput value={hwDue} onChangeText={setHwDue} placeholder={format(new Date(), "yyyy-MM-dd")} placeholderTextColor={colors.muted}
                      style={{ backgroundColor: colors.inputBg, borderRadius: 0, padding: 14, color: colors.text, borderWidth: 1, borderColor: hwDue ? TAB_COLORS.Homework : colors.border, marginBottom: 16, fontSize: 14 }} />
                  </>
                )}
                ...
                {activeTab === "Papers" && (
                  <>
                      ...
                      {["All", ...GRADES_OPTIONS].map((g) => {
                        ...
                        return (
                          <TouchableOpacity key={g} onPress={() => setPpGrade(isAll ? "" : g)}
                            style={{ flex: 1, paddingVertical: 10, borderRadius: 0, alignItems: "center", backgroundColor: active ? TAB_COLORS.Papers : colors.inputBg, borderWidth: 1, borderColor: active ? TAB_COLORS.Papers : colors.border }}>
                    ...
                    <TextInput value={ppSubject} onChangeText={setPpSubject} placeholder="e.g. Mathematics" placeholderTextColor={colors.muted}
                      style={{ backgroundColor: colors.inputBg, borderRadius: 0, padding: 14, color: colors.text, borderWidth: 1, borderColor: ppSubject ? TAB_COLORS.Papers : colors.border, marginBottom: 16, fontSize: 14 }} />
                    ...
                    <TextInput value={ppYear} onChangeText={setPpYear} placeholder="2024" placeholderTextColor={colors.muted} keyboardType="numeric"
                      style={{ backgroundColor: colors.inputBg, borderRadius: 0, padding: 14, color: colors.text, borderWidth: 1, borderColor: TAB_COLORS.Papers, marginBottom: 16, fontSize: 14 }} />
                    ...
                    <View style={{ flexDirection: "row", flexWrap: "wrap", gap: 8, marginBottom: 16 }}>
                      {TERMS.map((t) => (
                        <TouchableOpacity key={t} onPress={() => setPpTerm(t)}
                          style={{ paddingHorizontal: 14, paddingVertical: 8, borderRadius: 0, backgroundColor: ppTerm === t ? TAB_COLORS.Papers : colors.inputBg, borderWidth: 1, borderColor: ppTerm === t ? TAB_COLORS.Papers : colors.border }}>
                    ...
                    <TextInput value={ppFileUrl} onChangeText={setPpFileUrl} placeholder="https://drive.google.com/..." placeholderTextColor={colors.muted}
                      style={{ backgroundColor: colors.inputBg, borderRadius: 0, padding: 14, color: colors.text, borderWidth: 1, borderColor: ppFileUrl ? TAB_COLORS.Papers : colors.border, marginBottom: 16, fontSize: 14 }} />
                  </>
                )}
                      ...
                      <View style={{ flexDirection: "row", gap: 8 }}>
                        {DAYS.map((d) => (
                          <TouchableOpacity key={d} onPress={() => setTtDay(d)}
                            style={{ paddingHorizontal: 14, paddingVertical: 8, borderRadius: 0, backgroundColor: ttDay === d ? TAB_COLORS.Timetable : colors.inputBg, borderWidth: 1, borderColor: ttDay === d ? TAB_COLORS.Timetable : colors.border }}>
                    ...
                    <View style={{ flexDirection: "row", gap: 6, marginBottom: 16 }}>
                      {GRADES_OPTIONS.map((g) => (
                        <TouchableOpacity key={g} onPress={() => setTtGrade(g)}
                          style={{ flex: 1, paddingVertical: 10, borderRadius: 0, alignItems: "center", backgroundColor: ttGrade === g ? TAB_COLORS.Timetable : colors.inputBg, borderWidth: 1, borderColor: ttGrade === g ? TAB_COLORS.Timetable : colors.border }}>
                    ...
                    <View style={{ flexDirection: "row", gap: 6, marginBottom: 16 }}>
                      {SECTIONS_OPTIONS.map((s) => (
                        <TouchableOpacity key={s} onPress={() => setTtSection(s)}
                          style={{ flex: 1, paddingVertical: 10, borderRadius: 0, alignItems: "center", backgroundColor: ttSection === s ? TAB_COLORS.Timetable : colors.inputBg, borderWidth: 1, borderColor: ttSection === s ? TAB_COLORS.Timetable : colors.border }}>
                    ...
                    {[["Period #", ttPeriod, setTtPeriod, "e.g. 1"], ["Subject", ttSubject, setTtSubject, "e.g. Mathematics"], ["Start (HH:MM)", ttStart, setTtStart, "08:00"], ["End (HH:MM)", ttEnd, setTtEnd, "09:00"]].map(([label, val, setter, ph]: any) => (
                      <View key={label}>
                        ...
                        <TextInput value={val} onChangeText={setter} placeholder={ph} placeholderTextColor={colors.muted}
                          ...
                          style={{ backgroundColor: colors.inputBg, borderRadius: 0, padding: 14, color: colors.text, borderWidth: 1, borderColor: val ? TAB_COLORS.Timetable : colors.border, marginBottom: 16, fontSize: 14 }} />
                      </View>
                    ))}
                  </>
                )}
                ...
                <View style={{ backgroundColor: colors.accent + "12", borderRadius: 0, padding: 14, marginBottom: 20, borderWidth: 1, borderColor: colors.accent + "30", flexDirection: "row", gap: 10, alignItems: "flex-start" }}>
                ...
                <TouchableOpacity
                  ...
                  disabled={isPending}
                  style={{ backgroundColor: TAB_COLORS[activeTab], borderRadius: 0, padding: 18, alignItems: "center", marginBottom: 12, flexDirection: "row", justifyContent: "center", gap: 8 }}
                >
                ...
                <TouchableOpacity onPress={resetModal} style={{ borderRadius: 0, padding: 16, alignItems: "center", borderWidth: 1, borderColor: colors.border, marginBottom: 8 }}>
