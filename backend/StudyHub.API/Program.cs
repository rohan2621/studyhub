...
var appsPath = Path.Combine(app.Environment.ContentRootPath, "wwwroot", "apps");
...
{
    FileProvider = new Microsoft.Extensions.FileProviders.PhysicalFileProvider(appsPath),
    RequestPath = "/apps",
