...
namespace StudyHub.API.Migrations
{
    ...
    public partial class AddLearningSystem : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CourseBookmarks_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FlashcardDecks_Lessons_LessonId",
                        column: x => x.LessonId,
            ...
            migrationBuilder.CreateTable(
                name: "LessonRelations",
                columns: table => new
                {
                    LessonId = table.Column<Guid>(type: "uuid", nullable: false),
                    RelatedLessonId = table.Column<Guid>(type: "uuid", nullable: false),
                    RelationType = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LessonRelations", x => new { x.LessonId, x.RelatedLessonId });
                    table.ForeignKey(
                        name: "FK_LessonRelations_Lessons_LessonId",
                        column: x => x.LessonId,
                        principalTable: "Lessons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LessonRelations_Lessons_RelatedLessonId",
                        column: x => x.RelatedLessonId,
                        principalTable: "Lessons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LessonId = table.Column<Guid>(type: "uuid", nullable: false),
                    Title = table.Column<string>(type: "text", nullable: false),
                    PassScorePercent = table.Column<decimal>(type: "numeric", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseBookmarks_UserId_CourseId",
                table: "CourseBookmarks",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FlashcardDecks_LessonId",
                table: "FlashcardDecks",
                column: "LessonId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FlashcardProgresses_UserId_FlashcardId",
                table: "FlashcardProgresses",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LessonRelations_RelatedLessonId",
                table: "LessonRelations",
                column: "RelatedLessonId");
